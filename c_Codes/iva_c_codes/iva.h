...
typedef struct iva_parameters {
    int frame_len,nfft,frame_shift,overlap,shift,nframes,nfreq,sp,maxiter,n;
   ...
   void(*enhance_signal)(struct iva_parameters *iva, double *input1, double *input2);
    int a;
    ...
    double *Q1_real, *Q1_imag, *Q3_real, *Q3_imag, *Q2, *Q4, *W1_r,*W2_r,*W3_r,*W4_r,*W1_i,*W2_i,*W3_i,*W4_i, *phi1_real, *phi1_imag, *phi2_real, *phi2_imag, *win2, *x_prev1, *x_prev2, *v1prev, *x1_prev, *x2_prev;
    ...
    double *S12_r, *S12_i, *S22_r, *S22_i,*X_final1_r, *X_final1_i, *X_final2_r, *X_final2_i, *sk1, *sk2, *v1, *v2, *yf1, *yf2, *xi_w1,*xi_w2;
}iva_parameters;

void enhance_signal(iva_parameters *iva, double *input1, double *intput2);
